...
class PeminjamanController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		$fields = array("no_transaksi", 
			...
			"lama_peminjaman", 
			"harga", 
			"lama_peminjaman * harga AS TOTAL");
		$pagination = $this->get_pagination(MAX_RECORD_COUNT); // get current pagination e.g array(page_number, page_limit)
		//search table record
		if(!empty($request->search)){
			$text = trim($request->search); 
			$search_condition = "(
				peminjaman.no_transaksi LIKE ? OR 
				peminjaman.tgl_peminjaman LIKE ? OR 
				peminjaman.id_petugas LIKE ? OR 
				peminjaman.id_penyewa LIKE ? OR 
				peminjaman.no_pol LIKE ? OR 
				peminjaman.lama_peminjaman LIKE ? OR 
				peminjaman.harga LIKE ? OR 
				lama_peminjaman * harga LIKE ? OR 
				peminjaman.id_peminjaman LIKE ?
			)";
			$search_params = array(
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("no_transaksi","tgl_peminjaman","id_petugas","id_penyewa","no_pol","lama_peminjaman","harga");
