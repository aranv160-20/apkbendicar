...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add New Petugas</h4>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-id_petugas"  value="<?php  echo $this->set_field_value('id_petugas',""); ?>" type="text" placeholder="Enter Id Petugas"  required="" name="id_petugas"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <select required=""  id="ctrl-nm_petugas" name="nm_petugas"  placeholder="Select a value ..."    class="custom-select" >
                                                        ...
                                                        $selected = $this->set_field_selected('nm_petugas',$value, "");
                                                        ?>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-gaji"  value="<?php  echo $this->set_field_value('gaji',""); ?>" type="number" placeholder="Enter Gaji" step="1"  required="" name="gaji"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
