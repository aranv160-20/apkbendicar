            ...
            <div class="container">
                <div class="row ">
                    <div class="col-md-8 comp-grid">
                        <div class=""><style>
                            body{
                            background-image: url(assets/images/bggerak.gif);
                            background-repeat: no-repeat;
                            background-size: cover;
                            font-family: arial;
                            }
                        </style>
                        <div><h3><b>Selamat Datang di Layanan Penyewaan Mobil Bendi Car</b></h3></div>
                    </div>
                </div>
                <div class="col-md-4 comp-grid">
                    <?php $this :: display_page_errors(); ?>
                    
                    <div  class="text-dark animated bounceIn page-content">
                        <div>
