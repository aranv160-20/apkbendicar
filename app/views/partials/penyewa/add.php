...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add New Penyewa</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="penyewa-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("penyewa/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-id_penyewa"  value="<?php  echo $this->set_field_value('id_penyewa',""); ?>" type="text" placeholder="Enter Id Penyewa"  required="" name="id_penyewa"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <select required=""  id="ctrl-nm_penyewa" name="nm_penyewa"  placeholder="Select a value ..."    class="custom-select" >
                                                        ...
                                                        $selected = $this->set_field_selected('nm_penyewa',$value, "");
                                                        ?>
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    ...
                                                    $checked = $this->set_field_checked('jk', $value, "");
                                                    ?>
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <textarea placeholder="Enter Alamat Penyewa" id="ctrl-alamat_penyewa"  required="" rows="5" name="alamat_penyewa" class=" form-control"><?php  echo $this->set_field_value('alamat_penyewa',""); ?></textarea>
