		...
		<table class="table table-sm">
			<tr>
				...
				<th align="middle" valign="middle">
					...
					<h4 class="sub-title">Ara Group Corporation</h4>
					<div></div>
					
						<div><span class="sub-title">Phone: +6285308030003</span></div>
						<div><span class="sub-title">Email: aragroupcorporation@gmail.com</span></div>
						<div><span class="sub-title">Web: <?php echo SITE_ADDR ?></span></div>
					</div> 
				</th>
